    ...
    <div class="footer text-white py-10">
      <div class="container mx-auto -md:px-5">
        <div class="flex items-center -sm:block">
          <div class="w-4/12 text-center -sm:w-full -sm:py-2 -sm:text-left">
          ...
          <div
            class="w-2/12 text-center underline -sm:w-full -sm:py-2 -sm:text-left"
          >
            <span>Mention légales</span>
          </div>
          <div
            class="w-3/12 text-center -sm:w-full -sm:py-2 -sm:mt-5 -sm:text-left"
          >
            <span
              >Réalisé avec
              <img
